...
The function of *jflip* is to generate white noises from input by randomly flipping 
the audiotory signals. The overall waveform is kept but frequency information totally
discrupted. 
