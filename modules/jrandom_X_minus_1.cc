...
#define PROGRAM_NAME "jrandom_X_minus_1"

using namespace jill;
using std::string;
typedef std::vector<string> stringvec;

class jrandom_minus_one_options : public program_options {

public:
	jrandom_minus_one_options(string const &program_name);
...
}; // jrandom_X_minus_1_options

static jrandom_minus_one_options options(PROGRAM_NAME);
...
jrandom_minus_one_options::jrandom_minus_one_options(string const &program_name)
...
void
jrandom_minus_one_options::print_usage()
{
